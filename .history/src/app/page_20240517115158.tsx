...
const Container = () => (
  <main className="flex h-full w-full gap-24 p-3">
    <div className="flex w-1/2 flex-col justify-center gap-12">
      ...
      <div className="flex gap-5">
        <Button className="bg-blue-600 p-20">Learn more</Button>
        <Button className="bg-white p-20 text-black">Contact</Button>
      </div>
