    ...
    <div className="flex h-full w-full gap-20">
      ...
      <div className="flex flex-col gap-8">
        ...
        <p className="text-lg">
          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi mollitia odio nisi dolorum totam quas, quis voluptates quo voluptatibus reprehenderit voluptas, beatae similique tempore sint. Libero ullam placeat explicabo iusto.
        </p>
      </div>
    </div>
  );
