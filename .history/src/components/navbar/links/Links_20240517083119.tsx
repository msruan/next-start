  ...
  return (
    <>
      ...
      >
        ...
        />
        {menuIsOpen && (
          <div className="absolute r-0 top-[100px] flex h-burger min-h-48 w-1/3 flex-col items-center justify-between border-l-2 border-l-black bg-slate-900 p-2 text-center">
