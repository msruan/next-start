      ...
      >
        ...
        {session ? (
          <>
            ...
            <Button className="cursor-pointer bg-white p-3 font-semibold text-slate-900 hover:text-white">
              Logout
            </Button>
          </>
        ) : (
            ...
            <div className="flex h-burger-div w-full flex-col items-center justify-between">
              ...
              {session ? (
                <>
                  ...
                  <Button className="cursor-pointer hover:border-white bg-white p-3 font-semibold text-slate-900 hover:text-white">
                    Logout
                  </Button>
                </>
              ) : (
