  ...
  return (
    <>
      ...
      >
        ...
        />
        {menuIsOpen && (
          <div className="absolute top-[100px] flex h-burger min-h-48 w-1/3 items-cen flex-col justify-between border-l-2 border-l-black bg-slate-900 p-2 text-center">
