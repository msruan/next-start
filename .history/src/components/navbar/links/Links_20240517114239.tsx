    ...
    <>
      ...
      {session ? (
        <>
          ...
          <Button className="cursor-pointer bg-white p-3 font-semibold text-slate-900  hover:border-red-200 hover:text-white">
            Logout
          </Button>
        </>
      ) : (
...
function Links({ className }: { className: string }) {
  ...
  return (
    <>
      ...
      >
        <ContentLinks session={session} isAdmin={false}></ContentLinks>
      </div>
